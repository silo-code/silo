...
// Gear body: the inner teeth outline (second subpath of gearPath, made
// absolute) plus the hub circle; with evenodd the hub becomes a hole, so the
// fill covers only the ring of body between the outline and the hub.
const bodyPath =
  "M11.61 3.75l-.98 1.47C10.05 6.08 9 6.5 7.99 6.27l-1.46-.34-.6.6.33 1.46c.24 1.01-.18 2.07-1.05 2.64l-1.46.98v.78l1.46.98c.87.57 1.29 1.63 1.05 2.64l-.33 1.46.6.6 1.46-.34c1.01-.23 2.06.19 2.64 1.05l.98 1.47h.78l.97-1.47c.58-.86 1.63-1.28 2.65-1.05l1.45.34.61-.6-.34-1.46c-.23-1.01.18-2.07 1.05-2.64l1.47-.98v-.78l-1.47-.98c-.87-.57-1.28-1.63-1.05-2.64l.34-1.46-.61-.6-1.45.34c-1.02.23-2.07-.19-2.65-1.05l-.97-1.47h-.78zM8.5 12c0-1.93 1.56-3.5 3.5-3.5 1.93 0 3.5 1.57 3.5 3.5s-1.57 3.5-3.5 3.5c-1.94 0-3.5-1.57-3.5-3.5z";
...
function GearIcon() {
  return (
    <svg
      ...
      fill="currentColor"
    >
      {/* Body shaded like the panel-toggle light body (currentColor @ 0.15). */}
      <path d={bodyPath} fillRule="evenodd" opacity={0.15} />
      <path d={gearPath} />
    </svg>
  );
}
