...
/** A live-preview center dock — fake browser chrome around a real page loaded in an iframe. `url` is the address shown in the chrome; `src` is what actually loads. */
...
/**
 * A second, shorter pass scoped to just the Navigator panel — for a cropped
 * feature vignette that only shows the left column. Skips every step that
 * targets the right-side panels or center dock (nothing to see there once
 * cropped) and only touches Navigator-owned controls: workspace switching,
 * the Agents/Workspaces view toggle, and adding/closing a workspace. Ends
 * back on the same website/docs/api, Workspaces-view state it opened on.
 */
export const navigatorDemoScript: DemoScriptStep[] = [
  { afterMs: 1800, selector: '[data-demo-target="workspace:docs"]' },
  { afterMs: 1800, selector: '[data-demo-target="workspace:api"]' },
  { afterMs: 1800, selector: '[data-demo-target="workspace:website"]' },
  { afterMs: 2000, selector: '[data-demo-target="nav-view-btn"]' },
  { afterMs: 900, selector: '[data-demo-target="nav-view:agents"]' },
  { afterMs: 2200, selector: '[data-demo-target="agent-row:docs:claude"]' },
  { afterMs: 2200, selector: '[data-demo-target="agent-row:api:claude"]' },
  { afterMs: 2200, selector: '[data-demo-target="agent-row:website:cursor"]' },
  { afterMs: 2000, selector: '[data-demo-target="nav-view-btn"]' },
  { afterMs: 900, selector: '[data-demo-target="nav-view:workspaces"]' },
  { afterMs: 2000, selector: '[data-demo-target="add-workspace"]' },
  { afterMs: 900, selector: '[data-demo-target="open-workspace:mobile"]' },
  { afterMs: 2200, selector: '[data-demo-target="close-workspace:mobile"]' },
];
