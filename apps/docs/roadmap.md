...
| Design-system components (modal kit)                  | <Badge type="info" text="planned" /> | [docs](/design/) · [RFC 0016](https://github.com/silo-code/silo/blob/main/docs/proposals/0016-modal-design-system.md) |
| `--silo-list-*` tokens + `.silo-scroll`               | <Badge type="info" text="planned" /> | [docs](/design/components/lists)                                                                                      |
