...
| Design-system components (modal kit)                  | <Badge type="warning" text="experimental" /> | [docs](/design/) · [RFC 0016](https://github.com/silo-code/silo/blob/main/docs/proposals/0016-modal-design-system.md) |
