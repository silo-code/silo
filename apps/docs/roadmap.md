...
| `ctx.agents` (coding-agent activity + resume hints)                  | <Badge type="warning" text="experimental" /> | [RFC 0017](https://github.com/silo-code/silo/blob/main/docs/proposals/0017-ctx-agents-surface.md)                     |
...
| context-menu contributions (workspace, terminal/link)                | <Badge type="tip" text="stable" />           | [docs](/api/registration/register-context-menu-item)                                                                  |
| context-menu contributions (explorer/item, editor/tab, terminal/tab) | <Badge type="info" text="planned" />         | [design](#context-menus)                                                                                              |
