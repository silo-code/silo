...
| [`ctx.workspaces`](/api/state/workspaces) | workspaces &amp; editor tabs; `registerDecoration` to add status rows below workspace items in the side panel ([`WorkspaceService`](/api/types/interfaces/WorkspaceService)) |
