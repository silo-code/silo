# Type Alias: ToolbarSpacerSize

```ts
type ToolbarSpacerSize = "sm" | "md" | "lg";
```

Defined in: [packages/sdk/src/toolbar-items.ts:178](https://github.com/silo-code/silo/blob/main/packages/sdk/src/toolbar-items.ts#L178)
