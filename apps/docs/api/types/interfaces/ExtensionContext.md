...
Unlike [SidePanelProps.storage](SidePanelProps.md#storage) (panel-local UI state), this is the
...
Safe to call `.get()` / `.set()` immediately in [Extension.activate](Extension.md#activate) —
...
Defined in: [packages/sdk/src/types.ts:491](https://github.com/silo-code/silo/blob/main/packages/sdk/src/types.ts#L491)
...
Defined in: [packages/sdk/src/types.ts:520](https://github.com/silo-code/silo/blob/main/packages/sdk/src/types.ts#L520)
...
Defined in: [packages/sdk/src/types.ts:430](https://github.com/silo-code/silo/blob/main/packages/sdk/src/types.ts#L430)
