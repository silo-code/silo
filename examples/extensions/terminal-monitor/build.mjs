...
const installed = `${homedir()}/.config/silo-dev/extensions/silo.terminal-monitor/dist/index.js`;
if (existsSync(installed)) {
  copyFileSync("dist/index.js", installed);
  console.log(
    "  synced → ~/.config/silo-dev/extensions/silo.terminal-monitor/dist/index.js",
  );
}
